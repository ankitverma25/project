...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 to-green-500 p-8">
      <div className="max-w-[1440px] mx-auto">
        {/* Hero Section */}
        <div className="relative h-[400px] mb-16 rounded-xl overflow-hidden">
          <img
            src="https://public.readdy.ai/ai/img_res/d472c870562c7b99405e08441b287e9b.jpg"
          ...
          <div className="absolute inset-0 bg-green-900 bg-opacity-50">
            <div className="h-full flex flex-col justify-center max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200">
                We're here to help with your automotive recycling needs. Reach
                out to our expert team for professional assistance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          {/* Contact Form */}
          <div className="bg-green-200 rounded-xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border-none bg-gray-100 focus:ring-2 focus:ring-green-500"
                  required
                />
              </div>
              <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 9696560711</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <svg
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">av9696560@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Map Section */}
        <div className="bg-green-200 rounded-xl p-8 shadow-2xl mb-16">
          <h2 className="text-3xl font-bold mb-6">Find Us</h2>
          <div className="h-[400px] rounded-lg overflow-hidden">
            <iframe
              title="Google Map"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.367521943678!2d77.06551431508245!3d28.62873998242089!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d04b3c2f8c1e5%3A0x9f9b9b9b9b9b9b9b!2sIndia%20Gate!5e0!3m2!1sen!2sin!4v1631012345678!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
