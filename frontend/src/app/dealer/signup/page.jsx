    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-green-100">
      ...
      >
        ...
        <input
          ...
          className={`w-full border border-blue-200 rounded px-3 py-2 mb-1 focus:ring-2 focus:ring-blue-400 ${formik.touched.name && formik.errors.name ? 'border-red-400' : ''}`}
          required
        />
        ...
        <input
          ...
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          className={`w-full border border-blue-200 rounded px-3 py-2 mb-1 focus:ring-2 focus:ring-blue-400 ${formik.touched.businessName && formik.errors.businessName ? 'border-red-400' : ''}`}
          required
        />
        {formik.touched.businessName && formik.errors.businessName && <div className="text-red-500 text-xs mb-2">{formik.errors.businessName}</div>}
        <input
          type="text"
          name="licenseNumber"
          ...
          onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          className={`w-full border border-blue-200 rounded px-3 py-2 mb-1 focus:ring-2 focus:ring-blue-400 ${formik.touched.licenseNumber && formik.errors.licenseNumber ? 'border-red-400' : ''}`}
          required
        />
        {formik.touched.licenseNumber && formik.errors.licenseNumber && <div className="text-red-500 text-xs mb-2">{formik.errors.licenseNumber}</div>}
        ...
        <div className="text-center text-sm mt-2 text-gray-500">
          Already have an account? <a href="/dealer/login" className="text-blue-600 hover:underline">Login</a>
        </div>
      </form>
    </main>
  );
